...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/UU_SNAKVX/708&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))_markup)
...
local photo = LuaTele.getUserProfilePhotos(SNAK)
local UserInfo = LuaTele.getUser(SNAK)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
local NamesBot = (Redis:get(SNAK.."SNAK:Name:Bot") or "بلاك")
local BotName = {
'اسمي  '..NamesBot..'🖤',
'اسمي '..NamesBot..'❤️',
'اسمي  '..NamesBot..'♥️',
...
if text == (Redis:get(SNAK.."SNAK:Name:Bot") or "ميلآن) then
local photo = LuaTele.getUserProfilePhotos(SNAK)
local UserInfo = LuaTele.getUser(SNAK)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
