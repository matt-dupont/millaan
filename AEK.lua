...
if text == (Redis:get(AEK.."AEK:Name:Bot") or "ميلأن") then
local NamesBot = (Redis:get(AEK.."AEK:Name:Bot") or "ميلأن")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local NamesBot = (Redis:get(AEK.."AEK:Name:Bot") or "ميلأن")
local BotName = {
"بوت في عينك اسمي "..NamesBot,
"دا انت قديم "..NamesBot.. "",
"خير"
}
...
{
{text = '• قناة السورس.', url = 't.me/UU_SNAK'},{text = '•شراء بوت.', url = 't.me/DDT5BOT'}, 
},
}
}
